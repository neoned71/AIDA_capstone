...
from utils import deduplicate_and_format_sources, tavily_search, format_sources, perplexity_search, duckduckgo_search
...
# for chunk in graph.stream({"messages": [("user", "Please generate a report")]},stream_mode="values",):
#     chunk["messages"][-1].pretty_print()


for chunk in graph.stream({"research_topic": "Quantum Mechanics","query":"how can it be integrated with gravity?"},stream_mode="values"):
    print(chunk)
    # chunk["messages"][-1].pretty_print()